                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs font-semibold text-slate-600 ml-1.5">{r.rating} / 5</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2 self-start sm:self-auto">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-100 hover:bg-primary/10 text-slate-700 hover:text-primary border border-slate-200 rounded-xl text-xs font-semibold transition-all"
                    >
                      <FiEdit3 size={13} />
