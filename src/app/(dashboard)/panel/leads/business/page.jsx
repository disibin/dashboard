...
export default function BusinessLeadsPage() {
  ...
  const fetchLeads = async () => {
    setLoading(true);
    try {
      const res = await axios.get('/api/staff/leads/business');
      if (res.data.success) {
  ...
  const handleSaveInlineEdit = async (id) => {
    ...
    setSavingEdit(true);
    try {
      const res = await axios.patch(`/api/staff/leads/business/${id}`, editForm);
      if (res.data.success) {
  ...
  const handleDelete = async (lead) => {
    ...
    setDeleting(lead.id);
    try {
      const res = await axios.delete(`/api/staff/leads/business/${lead.id}`);
      if (res.data.success) {
