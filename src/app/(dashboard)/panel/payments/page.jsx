...
export default function StaffPaymentsPage() {
  ...
  const [reviewAction, setReviewAction] = useState('approve'); // 'approve' | 'partial' | 'reject'
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 w-full space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-slate-900 mt-0.5">{formatCurrency(totalRevenue)}</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-amber-600 mt-0.5">{pendingCount} Action{pendingCount === 1 ? '' : 's'}</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-slate-900 mt-0.5">{formatCurrency(totalOutstanding)}</h3>
          </div>
        </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm flex items-center gap-4">
          ...
          <div>
            ...
            <h3 className="text-xl font-bold text-slate-900 mt-0.5">{paidCount} Paid</h3>
          </div>
        </div>
      </div>
      ...
      {/* Payment Inspection & Verification Modal */}
      {inspectPayment && (
          ...
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 sm:p-8 shadow-2xl border border-slate-100 space-y-6 my-8 animate-in fade-in zoom-in-95">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h3 className="text-lg font-bold text-slate-900">Payment Verification</h3>
            ...
            <div className="grid grid-cols-2 gap-3 text-xs bg-slate-50 p-4 rounded-2xl border border-slate-100">
              <div>
                ...
                <span className="font-bold text-slate-800">{inspectPayment.user_name}</span>
              ...
              <div className="grid grid-cols-2 gap-2 pt-1">
                ...
                {inspectPayment.note && (
                  <div className="col-span-2 pt-1">
                    ...
                    <p className="text-slate-700 bg-white/70 p-2 rounded-lg border border-amber-100 mt-0.5">
                      {inspectPayment.note}
                    </p>
                  </div>
                )}
            ...
            {/* Staff Verification Action Form */}
            <form onSubmit={handleProcessVerification} className="space-y-4 pt-2 border-t border-slate-100">
              <div className="space-y-1.5">
                <label className="text-xs font-bold text-slate-700 block">Verification Decision</label>
              ...
              <div className="flex items-center justify-end gap-2.5 pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={updating}
                  className={`px-5 py-2.5 rounded-xl text-xs font-bold text-white shadow-md flex items-center gap-1.5 transition-all cursor-pointer ${
