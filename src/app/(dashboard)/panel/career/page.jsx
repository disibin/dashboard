            ...
            <form onSubmit={handleSave} className="p-6 flex-1 overflow-y-auto space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Provide an overview of the position, mission, and staff structure..."
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Lead engineering staff, Manage Next.js architecture, Conduct code reviews"
                  className="input-style text-sm py-2"
                />
              </div>
