        ...
        {loading ? (
          ...
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <Link
              ...
              className="w-full py-3 text-center rounded-xl bg-slate-900 text-white font-semibold hover:bg-slate-700 transition-all duration-200 shadow-lg shadow-slate-900/10 mt-2"
            >
              Proceed to Login
            </Link>
          </div>
