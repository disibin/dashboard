 ...
 * TeamForm
 * --------
 * Form to add or edit a staff member.
 * Sends raw files directly to /api/staff via FormData.
 */
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (initialData) {
        ...
        res = await axios.patch('/api/staff', submitData, {
          headers: { 'Content-Type': 'multipart/form-data' }
        });
      } else {
        res = await axios.post('/api/staff', submitData, {
          headers: { 'Content-Type': 'multipart/form-data' }
        });
      }
