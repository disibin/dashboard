...
import {
  FiSearch, FiX, FiUser, FiCreditCard, FiPackage,
  FiBox, FiBookOpen, FiLifeBuoy, FiStar,
  FiBell, FiSettings, FiShield, FiArrowRight,
  FiMenu, FiShoppingCart, FiFolder
} from 'react-icons/fi'
    ...
    <header className="w-full h-14 fixed top-0 left-0 right-0 px-4 sm:px-4 bg-white/90 backdrop-blur-md border-b border-slate-100 shadow-xs flex items-center justify-between z-50">
      <div className="flex items-center gap-3">
        <button
          ...
          className="cursor-pointer px-2.5 py-1.5 rounded-xl text-slate-700 hover:text-slate-900 transition-all flex items-center gap-2 shadow-xs"
        ...
        <Link href="/user" className="text-base font-semibold text-slate-900 tracking-tight hidden sm:block">
          Dashboard
        </Link>
      </div>
