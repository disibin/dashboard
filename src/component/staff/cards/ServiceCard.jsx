...
import { FiGlobe, FiEdit2, FiTrash2, FiDollarSign } from 'react-icons/fi';
import { formatCurrency } from '@/lib/database/secret';

export default function StaffServiceCard({ service, index = 0, onEdit, onDelete, onRecordPayment }) {
  ...
  const targetHref = `/panel/services/${service.slug || service.id}`;
