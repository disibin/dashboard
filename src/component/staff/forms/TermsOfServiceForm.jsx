    ...
    <div className="bg-white rounded-3xl border border-slate-200/80 shadow-md p-4 sm:p-5 mb-8 animate-in fade-in duration-200">
      <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
        <h3 className="text-lg font-semibold text-slate-900 flex items-center gap-2">
          ...
          {isEditing ? 'Edit Terms of Service Item' : 'Add New Terms of Service Item'}
        </h3>
        <button
          type="button"
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="sm:col-span-2">
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 mb-2">
              Terms Section Title <span className="text-rose-500">*</span>
            </label>
            <input
              type="text"
              required
        ...
        <div>
          <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 mb-2">
            Terms of Service Content <span className="text-rose-500">*</span>
          </label>
          <textarea
            required
            rows={8}
