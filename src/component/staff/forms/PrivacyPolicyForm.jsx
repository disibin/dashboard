    ...
    <div className="bg-white rounded-3xl border border-slate-200/80 shadow-md p-4 sm:p-5 mb-8 animate-in fade-in duration-200">
      <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-6">
        <h3 className="text-lg font-semibold text-slate-900 flex items-center gap-2">
          ...
          {isEditing ? 'Edit Privacy Policy Item' : 'Add New Privacy Policy Item'}
        </h3>
        <button
          type="button"
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="sm:col-span-2">
            <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 mb-2">
              Privacy Section Title <span className="text-rose-500">*</span>
            </label>
            <input
              type="text"
              required
              placeholder="e.g. Data Collection & Usage Practices"
        ...
        <div>
          <label className="block text-xs font-semibold uppercase tracking-wider text-slate-700 mb-2">
            Privacy Policy Content <span className="text-rose-500">*</span>
          </label>
          <textarea
            required
            rows={8}
            placeholder="Enter privacy policy details for this section..."
        ...
        <div className="flex items-center gap-3 pt-2">
          <input
            type="checkbox"
            id="privacy_policy_is_published"
            checked={formData.is_published}
            onChange={(e) => setFormData({ ...formData, is_published: e.target.checked })}
            className="input-style cursor-pointer"
          />
          <label htmlFor="privacy_policy_is_published" className="text-sm font-medium text-slate-700 cursor-pointer">
